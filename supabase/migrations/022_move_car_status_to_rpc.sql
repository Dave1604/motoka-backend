...
-- Migration 022: Move car status update into RPC function for atomicity
-- =============================================

-- Update process_payment_success to also update car status atomically
-- This ensures car status is updated in the same transaction as payment and order creation
