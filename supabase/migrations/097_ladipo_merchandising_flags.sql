-- Migration 097: RECOVERED copy of _duplicates/067_ladipo_merchandising_flags.sql
-- (identical twin of _duplicates/071). Same story as 096: renumbering orphaned it,
-- production has the columns only by hand. All statements are IF NOT EXISTS-safe.
-- =============================================
